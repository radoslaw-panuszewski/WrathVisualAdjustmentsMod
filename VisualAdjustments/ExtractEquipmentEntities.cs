...
{
    internal static class ExtractEquipmentEntity
    {
        private static IEnumerable<EquipmentEntity> ExtractEquipmentEntities(this UnitEntityView view, [JetBrains.Annotations.CanBeNull] ItemEntity item)
        {
            try
            {
        ...
        public static IEnumerable<EquipmentEntity> ExtractEquipmentEntities(this UnitEntityView view, ItemSlot slot)
        {
