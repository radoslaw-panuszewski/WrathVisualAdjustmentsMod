...
{
    internal class HandsEquipmentManager
    {
        ...
        private static class UnitViewHandsEquipment_UpdateBeltPrefabs_Patch
        {
        ...
        private static class UnitViewHandsSlotData_ReattachSheath_Patch
        {
            private static bool HasQuiver(UnitViewHandSlotData slotData)
            {
        ...
        private static class UnitViewHandsSlotData_AttachModel_Patch
        {
        ...
        private static class UnitViewHandsSlotData_OwnerWeaponScale_Patch
        {
